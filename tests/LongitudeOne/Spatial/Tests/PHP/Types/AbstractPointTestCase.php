...
/**
 * Shared subject configuration for AbstractPoint contract tests.
 *
 * @internal
 */
abstract class AbstractPointTestCase extends TestCase
{
    protected const DELTA = 0.000000000001;
     ...
     */
    protected static function assertObjectHasMethod(object $object, string $method): void
    {
