...
use LongitudeOne\Spatial\ORM\Query\AST\Functions\MariaDB\SpDistance;
...
/**
 * ST_Distance MariaDB function tests.
 * Be careful, MariaDB implements ST_Distance, but this function does not respect the OGC Standard.
...
class SpDistanceTest extends PersistOrmTestCase
{
    ...
    public function testSelectStDistanceGeometry(): void
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT p, MariaDB_Distance(p.point, ST_GeomFromText(:p1)) FROM LongitudeOne\Spatial\Tests\Fixtures\PointEntity p'
        );
