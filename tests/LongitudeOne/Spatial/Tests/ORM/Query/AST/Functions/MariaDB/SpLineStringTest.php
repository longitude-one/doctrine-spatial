...
class SpLineStringTest extends PersistOrmTestCase
{
    ...
    public function testPredicate(): void
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT l FROM LongitudeOne\Spatial\Tests\Fixtures\LineStringEntity l WHERE MariaDB_LineString(MariaDB_Point(:x, :x), MariaDB_Point(:y, :y)) = l.lineString'
        );
    ...
    public function testSelect(): void
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT l, ST_AsText(MariaDB_LineString(MariaDB_Point(:x, :y), MariaDB_Point(:y, :x))) FROM LongitudeOne\Spatial\Tests\Fixtures\LineStringEntity l'
        );
