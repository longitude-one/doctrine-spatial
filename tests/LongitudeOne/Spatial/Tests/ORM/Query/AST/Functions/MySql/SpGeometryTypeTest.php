...
use LongitudeOne\Spatial\ORM\Query\AST\Functions\MySql\SpGeometryType;
...
/**
 * Sp_GeometryType DQL function tests.
...
class SpGeometryTypeTest extends PersistOrmTestCase
{
    ...
    public function testGeometryType(): void
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT Mysql_GeometryType(l.lineString) FROM LongitudeOne\Spatial\Tests\Fixtures\LineStringEntity l'
        );
