...
use LongitudeOne\Spatial\ORM\Query\AST\Functions\MariaDB\SpPoint;
...
/**
 * MariaDB_Point DQL function tests.
 *
...
class SpPointTest extends PersistOrmTestCase
{
    ...
    public function testSelect(): void
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT t, ST_AsText(MariaDB_Point(:x, :y)) FROM LongitudeOne\Spatial\Tests\Fixtures\PointEntity t'
        );
