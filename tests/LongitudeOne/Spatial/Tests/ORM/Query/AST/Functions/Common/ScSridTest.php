...
/**
 * Common_SRID DQL function tests.
 *
...
class ScSridTest extends PersistOrmTestCase
{
    ...
    public function testFunctionWithGeography(): void
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT Common_SRID(g.geography) FROM LongitudeOne\Spatial\Tests\Fixtures\GeographyEntity g'
        );
    ...
    public function testFunctionWithGeometry(): void
    {
        ...
        static::assertSame($expected, $result[0][1]);
    }
}
