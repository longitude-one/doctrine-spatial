...
class StIntersectsTest extends PersistOrmTestCase
{
    ...
    public function testSelectStDisjoint(): void
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT p, ST_Intersects(p.polygon, ST_GeomFromText(:p1, 0)) FROM LongitudeOne\Spatial\Tests\Fixtures\PolygonEntity p'
        );
    ...
    public function testStDisjointWhereParameter(): void
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT p FROM LongitudeOne\Spatial\Tests\Fixtures\PolygonEntity p WHERE ST_Intersects(p.polygon, ST_GeomFromText(:p1, 0)) = true'
        );
