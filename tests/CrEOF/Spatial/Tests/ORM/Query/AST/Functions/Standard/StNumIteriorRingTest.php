...
class StNumInteriorRingTest extends OrmTestCase
{
    ...
    public function testSelectStNumInteriorRing()
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT p, ST_NumInteriorRing(p.polygon) FROM CrEOF\Spatial\Tests\Fixtures\PolygonEntity p'
        );
    ...
    public function testStNumInteriorRingInPredicate()
    {
        ...
        $query = $this->getEntityManager()->createQuery(
            'SELECT p FROM CrEOF\Spatial\Tests\Fixtures\PolygonEntity p WHERE ST_NumInteriorRing(p.polygon) = :p'
        );
